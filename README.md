...
1. Clone this repository
   ...
   ```
      git clone https://github.com/TanujManikyala/Authentication-System
   ```

2. Open a terminal and navigate to the project **'authentication-system'** folder

   ```
      cd path/.../authentication-system-django
   ```

3. Create a virtual environment in the **'authentication-system'** folder
...
6. Use the console to navigate to the **'authentication-system\lss'** folder
...
9. Navigate to folder **'authentication-system\lss\lss'**
...
10. Navigate to the **'authentication-system\lss\lss'** folder, open the **info.py** file and paste your *Email* and *App password*
...
11. Use the console to navigate to the **'authentication-system\lss'** folder and run the server 
